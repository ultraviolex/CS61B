...
public class IntListTest {
    ...
    public void testSquareListRecursive() {
        ...
        assertEquals(IntList.list(1, 4, 9), N);
        IntList empty = IntList.list();
        IntList emptySquared = IntList.squareListRecursive(empty);
        assertEquals(IntList.list(), empty);
        assertEquals(IntList.list(), emptySquared);
        IntList yee = IntList.list(-1, 2, -3, 1, 2, 3);
        IntList haw = IntList.squareListRecursive(yee);
        assertEquals(IntList.list(-1, 2, -3, 1, 2, 3), yee);
        assertEquals(IntList.list(1, 4, 9, 1, 4, 9), haw);
        IntList A = IntList.list(-1);
        IntList B = IntList.squareListRecursive(A);
        assertEquals(IntList.list(-1), A);
        assertEquals(IntList.list(1), B);
    }
