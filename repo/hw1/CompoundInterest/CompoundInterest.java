...
public class CompoundInterest {
    ...
    static double futureValueReal(double presentValue, double rate,
        ...
        double futureValueNominal = futureValue(presentValue, rate, targetYear);
        return futureValueNominal * (Math.pow(1 - inflationRate / 100, numYears(targetYear)));
    }
    ...
    static double totalSavingsReal(double perYear, int targetYear, double rate,
        ...
        double savingsNominal = totalSavings(perYear, targetYear, rate);
        double savingsReal = savingsNominal * Math.pow(1 - inflationRate / 100, numYears(targetYear));
        return savingsReal;
    }
