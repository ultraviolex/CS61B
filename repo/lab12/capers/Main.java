...
public class Main {
    ...
    /** Dogs folder. */
    static File DOGS_FOLDER = Utils.join(CAPERS_FOLDER, "dogs");

    /** Story folder. */
    static File STORY_FOLDER = Utils.join(CAPERS_FOLDER, "story.txt");
    ...
    public static void setupPersistence() {
        ...
        if (!STORY_FOLDER.exists()) {
            try {
                ...
                System.out.println("Something wrong in main with create story");
            }
        }
        // FIXME
    }
    ...
    public static void writeStory(String[] args) {
        ...
        // FIXME
        String currentStory = Utils.readContentsAsString(STORY_FOLDER);
        String newStory = currentStory + args[1] + "\n";
